...
void init_stack(digraph_struct *self) { self->m_stack_top = 0; }
...
int depth_of_stack(digraph_struct *self) { return self->m_stack_top; }
...
void digraph_data_union(digraph_struct *self, int left_hand, int right_hand) {
  self->m_unioned_data[left_hand] |= self->m_unioned_data[right_hand];
}
