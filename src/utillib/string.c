 ...
 */
void utillib_string_clear(utillib_string * self)
{
	self->size = 0;
}
 ...
 * \return size.
 */
size_t utillib_string_size(utillib_string * self)
{
	return self->size;
}
 ...
 */
size_t utillib_string_capacity(utillib_string * self)
{
 ...
 */
bool utillib_string_empty(utillib_string * self)
{
	return self->size == 0;
}
