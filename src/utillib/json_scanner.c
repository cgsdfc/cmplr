...
static void json_scanner_collect_char(struct utillib_string_scanner *scanner,
                                      struct utillib_string *buffer) {
  utillib_string_append_char(buffer, utillib_string_scanner_lookahead(scanner));
  utillib_string_scanner_shiftaway(scanner);
}

static void json_scanner_collect_digit(struct utillib_string_scanner *scanner,
                                       struct utillib_string *buffer) {
  int ch;
...
static int json_scanner_read(struct utillib_string_scanner *scanner,
                             struct utillib_string *buffer) {
