...
void utillib_vector2_init(struct utillib_vector2* self, size_t nrow, size_t ncol)
{
...
utillib_element_t utillib_vector2_at(struct utillib_vector2 * self, size_t row, size_t col)
{
  return self->array[ vector2_offset(self, row, col) ];
}

utillib_element_t utillib_vector2_set(struct utillib_vector2 *self , size_t row, size_t col, utillib_element_t data)
{
