...
static void valarray_initV(struct utillib_valarray *self,
    size_t nextend, va_list ap)
{
...
utillib_element_t valarray_setV(struct utillib_valarray *self, utillib_element_t data ...);

utillib_element_t utillib_valarray_get(struct utillib_valarray *self, ...);
utillib_element_t utillib_valarray_set(struct utillib_valarray *self, utillib_element_t data ...);
