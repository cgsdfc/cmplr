...
static utillib_json_value_t * json_symbol_kind_create(void *data, size_t offset)
{
...
UTILLIB_JSON_OBJECT_FIELD_BEGIN(Symbol_Fields)
  UTILLIB_JSON_OBJECT_FIELD_ELEM(struct utillib_symbol, "kind", kind, json_symbol_kind_create)
  UTILLIB_JSON_OBJECT_FIELD_ELEM(struct utillib_symbol, "value", value, utillib_json_int_create)
  UTILLIB_JSON_OBJECT_FIELD_ELEM(struct utillib_symbol, "name", name, utillib_json_string_create)
