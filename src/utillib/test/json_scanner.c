...
UTILLIB_TEST(json_scanner_keywords) {
  ...
  size_t const expected[] = {JSON_SYM_NULL,  JSON_SYM_TRUE, JSON_SYM_FALSE,
...
UTILLIB_TEST(json_scanner_punctuation) {
  char const *input = "\n \n { [ , : ] }  ";
  size_t const expected[] = {JSON_SYM_LB,    JSON_SYM_LK, JSON_SYM_COMMA,
...
UTILLIB_TEST(json_scanner_number) {
  ...
  size_t const expected_long[] = {JSON_SYM_LONG, UT_SYM_EOF};

  size_t const expected_real[] = {JSON_SYM_REAL, UT_SYM_EOF};
  ...
  UTILLIB_TEST_AUX_INVOKE(json_scanner_recognize, expected_real,
                          sign_expt_real);
...
UTILLIB_TEST(json_scanner_string) {
  size_t const expected_escaped[] = {JSON_SYM_STR, UT_SYM_EOF};
  ...
  size_t const expected[] = {JSON_SYM_STR, JSON_SYM_STR, JSON_SYM_STR,
                             UT_SYM_EOF};
  UTILLIB_TEST_AUX_INVOKE(json_scanner_recognize, expected, strings);
  char const *empty = "  \"\"  ";
  size_t const expected_empty[] = {JSON_SYM_STR, UT_SYM_EOF};
