...
UTILLIB_SYMBOL_TERMINAL(JSON_SYM_LONG)
UTILLIB_SYMBOL_TERMINAL(JSON_SYM_REAL)
...
UTILLIB_RULE_ELEM(JSON_SYM_VAL, JSON_SYM_LONG)
UTILLIB_RULE_ELEM(JSON_SYM_VAL, JSON_SYM_REAL)
...
UTILLIB_ETAB_BEGIN(utillib_json_parser_error_kind)
UTILLIB_ETAB_ELEM_INIT(JSON_ESTRING, "unterminated string")
UTILLIB_ETAB_ELEM_INIT(JSON_EESCAPE, "unrecognized escaped sequence")
