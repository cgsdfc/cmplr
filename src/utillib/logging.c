...
static void utillib_logging_core_set_logdir(utillib_logging_core_t *self, char const *logdir) {
  self->lco_logdir=logdir;
}

static void utillib_logging_core_set_stderr_threshold(utillib_logging_core_t *self, int level) {
...
static void core_push_free(utillib_logging_core_t *self, utillib_logging_msg_t *logmsg) {
...
static void core_init(utillib_logging_core_t *self,
                                      char const *prog) {
...
static utillib_logging_msg_t *core_make_logging_msg(utillib_logging_core_t *core,
                                               logging_level_t level,
                                               char const *file,
                                               char const *func, size_t line,
                                               char const *msg) {
...
static void core_push_back_logmsg(utillib_logging_core_t * self, utillib_logging_msg_t *msg) {
...
void utillib_logging_destroy(void) {
  core_destroy(&static_logging_core);
}
...
void utillib_logging_logmsg(int level, char const *file, char const *func, size_t line,
                    char const *fmt, ...) {
  va_list ap;
  va_start(ap, fmt);
