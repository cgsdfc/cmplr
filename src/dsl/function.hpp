...
function("function")("0", "1",
                     "2")(var("list") = list(), var("list")("append", "0"),
                          invoke("list", "append", "0"),
                          var("list")("append", str("0")),
                          for_("arg", args)(var("list")("append", "arg")),
                          for_("arg", "list")(print("arg is ", var("arg"))));

class_("Student")("Person")(member("name"),
                            function("print_name")()(call("function")("a", "b",
                                                                      "a")
                                                         print(var("name"))), );
