...
UTILLIB_ETAB_ELEM_INIT(SYM_ASSIGN_STMT, "assignment statement")
...
UTILLIB_ETAB_ELEM_INIT(SYM_COND, "condition")
UTILLIB_ETAB_ELEM_INIT(SYM_TERM, "term")
UTILLIB_ETAB_ELEM_INIT(SYM_FACT, "factor")
...
UTILLIB_ETAB_ELEM_INIT(SYW_KW_SWITCH, "switch")
