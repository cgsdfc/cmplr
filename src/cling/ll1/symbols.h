...
UTILLIB_ENUM_BEGIN(cling_ll1_symbol_kind)
...
UTILLIB_ENUM_ELEM(SYM_CONST_DEF_INT)
UTILLIB_ENUM_ELEM(SYM_CONST_DEF_CHAR)
...
UTILLIB_ENUM_ELEM(SYM_NARGS_LS)
UTILLIB_ENUM_ELEM(SYM_AARGS)
UTILLIB_ENUM_ELEM(SYM_AARGS_LS)
...
UTILLIB_ENUM_ELEM(SYM_EXPR_)
UTILLIB_ENUM_ELEM(SYM_COND)
UTILLIB_ENUM_ELEM(SYM_TERM)
UTILLIB_ENUM_ELEM(SYM_FACT)
UTILLIB_ENUM_ELEM(SYM_EXTEND)
UTILLIB_ENUM_ELEM(SYM_CONST_DEF_LS)
UTILLIB_ENUM_ELEM(SYM_CONST_DEF_INT_LS)
UTILLIB_ENUM_ELEM(SYM_CONST_DEF_CHAR_LS)
UTILLIB_ENUM_ELEM(SYM_VAR_DEF_LS)
UTILLIB_ENUM_ELEM(SYM_FUNC_DECL_LS)
UTILLIB_ENUM_ELEM(SYM_CASE_CLAUSE_LS)
...
UTILLIB_ENUM_END(cling_ll1_symbol_kind);

extern struct utillib_symbol const cling_ll1_symbols[];
