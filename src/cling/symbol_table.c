...
symbol_table_lexical_find(struct symbol_table const *self,
                char const *name) {
...
static bool
symbol_table_lexical_exist_name(struct symbol_table const *self,
                char const *name) {
...
static void symbol_entry_init(struct symbol_entry *self, int scope,
                int kind) {
        self->kind = kind;
        self->scope = scope;
}

static void symbol_entry_init_single_var(struct symbol_entry *self,
                int scope, int symbol) {
        symbol_entry_init(self, scope, symbol_to_type(symbol));
}

static void symbol_entry_init_const(struct symbol_entry *self, int scope,
...
static void symbol_entry_init_array(struct symbol_entry *self, int scope,
...
static void
symbol_entry_init_function(struct symbol_entry *self, int return_symbol,
