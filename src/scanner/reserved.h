...
#define SCANNER_MATCH_RESERVED_DECL(NAME)                                      \
  scanner_enum_value NAME(scanner_string lit)
#define SCANNER_MATCH_RESERVED_BEGIN(NAME)                                     \
  SCANNER_MATCH_RESERVED_DECL(NAME) {                                          \
  static scanner_str_val_pair_array NAME##_tab = {
#define SCANNER_MATCH_RESERVED_IMPL scanner_match_reserved
#define SCANNER_MATCH_RESERVED_END(NAME)                                       \
  (scanner_string) NULL, (scanner_enum_value)0                                 \
  }                                                                            \
  ;                                                                            \
