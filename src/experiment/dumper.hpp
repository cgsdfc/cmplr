...
class dumper {
 ...
 public:
  dumper()
      : m_allowed_dumps({"edges", "itemsets", "items", "rules", "symbols",
                         "terminals", "nonterminals"}) {
    m_options.add_options()("help", "print a help message")(
        "file", po::value<std::ofstream>(), "dump to specific file")(
        "what", po::value<std::vector<std : string>>()->multitokens(),
        "what kind of content you want to dump");
  }
