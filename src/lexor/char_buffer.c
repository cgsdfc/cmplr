 ...
 */
static int init_char_buffer(char_buffer *buffer, FILE *f, int chars,
                            int lines) {
  void *buf, *limits;
  char line[BUFSIZ];
  int i = 0;
...
int get_lineno(char_buffer *buffer) { return buffer->pos.lineno; }
...
void print_buffer(char_buffer *cb) {
