...
UTILLIB_ENUM_ELEM (NODE_TAG_DECL) UTILLIB_ENUM_END (node_tag)
...
// the visitor factory function
     ...
     void
     init_node_base (struct node_base *, node_tag);
     node_base *
     make_ternary_node (void);
     node_base *
     make_unary_node (int);
     node_base *
     make_binary_node (int);
     node_base *
     make_terminal_node (Token *);
     node_base *
     make_vector_node (void);
     int
     vector_node_push_back (struct vector_node *, struct node_base *);
     node_base *
     vector_node_at (struct vector_node *, size_t);
     size_t
     vector_node_size (struct vector_node *);
     void
     destroy_vector_node (struct vector_node *);
     node_base *
     make_nullary_node (void);
     void
     visit_node (void *, struct node_base *, vfactory *);
