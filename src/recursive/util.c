...
int util_is_list(pcontext *context, pfunction *parse, size_t least) {
  while (true) {
	...
	return util_is_surrounded (context, parse, TKT_LEFT_PARENTHESIS,
      ...
      {
	return util_is_surrounded (context, parse, TKT_LEFT_BRACE,
				   TKT_RIGHT_BRACE);
      }
