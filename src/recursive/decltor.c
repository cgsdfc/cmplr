...
static DECL_IS_FUNC_DECLARE(parameter_declare) {
...
static DECL_IS_FUNC_DECLARE(parameter_list) {
  return util_is_comma_sep_list(context, decl_is_parameter_declare,
                                true /* allow_empty */
                                );
}
...
static DECL_IS_FUNC_DECLARE(star) {
...
static DECL_IS_FUNC_DECLARE(decltor_primary) {
  // identifier | '(' decltor ')'
...
static DECL_IS_FUNC_DECLARE(abstract_decltor_primary) {
