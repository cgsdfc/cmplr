...
{
	return util_is_comma_sep_list(context, decl_is_init_decltor, true	/* allow_empty */
	    );
}
...
{
	return util_is_one_of(context, decl_is_declare, decl_is_function,
			      NULL);
}

DECL_IS_FUNC_DECLARE(translation)
{
	return util_is_list(context, decl_is_external,
			    true /* allow_empty */ );
}
