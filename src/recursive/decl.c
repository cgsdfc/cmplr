...
// function
// =============================================================== //
static DECL_IS_FUNC_DECLARE(function_impl) {
...
DECL_IS_FUNC_DECLARE(function) {
  ...
  if (util_is_sequence(context, decl_is_declare_specifier, decl_is_decltor,
...
static DECL_IS_FUNC_DECLARE(init_decltor) {
...
static DECL_IS_FUNC_DECLARE(init_decltor_list) {
  return util_is_comma_sep_list(context, decl_is_init_decltor,
                                true /* allow_empty */
                                );
}
...
static DECL_IS_FUNC_DECLARE(initializer_seq) {
  return util_is_sequence(context, decl_is_initializer_list,
                          decl_is_optional_comma, NULL);
}

static DECL_IS_FUNC_DECLARE(initializer_in_braces) {
  return util_is_in_braces(context, decl_is_initializer_seq);
}
...
static DECL_IS_FUNC_DECLARE(initializer_list) {
  return util_is_comma_sep_list(context, decl_is_initializer,
                                true /* allow_empty */
                                );
}
...
DECL_IS_FUNC_DECLARE(declare) {
  if (decl_is_declare_specifier(context)) {
    ...
    decl_is_init_decltor_list(context);
    pcontext_reduce_binary(context, DECL_DECLARE);
...
DECL_IS_FUNC_DECLARE(typename_) {
  ...
  if (decl_is_specifier_qualifier_list(context)) {
    ...
    pcontext_reduce_unary(context, DECL_TYPENAME);
    return true;
  }
  return false;
}
