...
{
	return util_is_one_of(context, decl_is_type_specifier,
...
static void reduce_declare_specifier(pcontext * context, vector_node ** v)
{
	...
	ternary_node *declare_specifier =
	    (ternary_node *) make_ternary_node();
