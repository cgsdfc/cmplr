...
linelimit = 200;
stacksize = 1450;
{ sticky naming covension XXsy. Why not use better naming ? }
type symbol = ( intcon, realcon, charcon, stringcon, { IntConst, RealConst, 
  ...
  index = -xmax..+xmax;
  { typedef char Alpha [Alng] }
  { Type alias for a fix size char array }

  alfa = packed array[1..alng]of char;

  { Object Type. enum objecttyp { Constant, Variable, Typel, Procedure, 
  Function }

  objecttyp = (konstant, vvariable, typel, prozedure, funktion );
  { Types Type. enum. All supported types }
  ...
  errpos:     integer;     { position of the error detected }
  ...
  { Defines a procedure to report errors }
procedure errormsg;
var k : integer;
