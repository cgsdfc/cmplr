...
UTILLIB_RULE_ELEM(SYM_SUBPRG, SYM_CONST_DECL, SYM_VAR_DECL, SYM_PROC_DECL,
                  SYM_PROC_DECL_LS, SYM_COMP_STMT)
...
size_t const pascal_firsts[][15] = {
        [SYM_PROGRAM] = {SYM_KW_CONST, SYM_KW_VAR, SYM_KW_PROC, SYM_IDEN,
                         SYM_KW_IF, SYM_KW_WHILE, SYM_KW_CALL, SYM_KW_BEGIN,
                         SYM_KW_READ, SYM_KW_WRITE, UT_SYM_EPS, UT_SYM_NULL},
        [SYM_SUBPRG] = {SYM_KW_CONST, SYM_KW_VAR, SYM_KW_PROC, SYM_IDEN,
                        SYM_KW_IF, SYM_KW_WHILE, SYM_KW_CALL, SYM_KW_BEGIN,
                        SYM_KW_READ, SYM_KW_WRITE, UT_SYM_EPS, UT_SYM_NULL},
        [SYM_CONST_DECL] = {SYM_KW_CONST, UT_SYM_NULL},
        [SYM_CONST_DEF] = {SYM_IDEN, UT_SYM_NULL},
        [SYM_VAR_DECL] = {SYM_KW_VAR, UT_SYM_NULL},
        [SYM_PROC_DECL] = {SYM_KW_PROC, UT_SYM_NULL},
        [SYM_PROC_HD] = {SYM_KW_PROC, UT_SYM_NULL},
        [SYM_STMT] = {SYM_IDEN, SYM_KW_IF, SYM_KW_WHILE, SYM_KW_CALL,
                      SYM_KW_BEGIN, SYM_KW_READ, SYM_KW_WRITE, UT_SYM_EPS,
                      UT_SYM_NULL},
        [SYM_ASS_STMT] = {SYM_IDEN, UT_SYM_NULL},
        [SYM_EXPR] = {SYM_ADD, SYM_MINUS, SYM_IDEN, SYM_UINT, SYM_LP,
                      UT_SYM_NULL},
        [SYM_TERM] = {SYM_IDEN, SYM_UINT, SYM_LP, UT_SYM_NULL},
        [SYM_FACT] = {SYM_IDEN, SYM_UINT, SYM_LP, UT_SYM_NULL},
        [SYM_ADD_OP] = {SYM_ADD, SYM_MINUS, UT_SYM_NULL},
        [SYM_MUL_OP] =
            {
                SYM_MUL, SYM_DIV, UT_SYM_NULL,
            },
        [SYM_COND] = {SYM_KW_ODD, SYM_IDEN, SYM_UINT, SYM_LP, UT_SYM_NULL},
        [SYM_REL_OP] = {SYM_NE, SYM_LT, SYM_LE, SYM_EQ, SYM_GT, SYM_GE,
                        UT_SYM_NULL},
        [SYM_COND_STMT] = {SYM_KW_IF, UT_SYM_NULL},
        [SYM_LOOP_STMT] = {SYM_KW_WHILE, UT_SYM_NULL},
        [SYM_CALL_STMT] =
            {
                SYM_KW_CALL, UT_SYM_NULL,
            },
        [SYM_COMP_STMT] = {SYM_KW_BEGIN, UT_SYM_NULL},
        [SYM_READ_STMT] = {SYM_KW_READ, UT_SYM_NULL},
        [SYM_WRITE_STMT] = {SYM_KW_WRITE, UT_SYM_NULL},
};
