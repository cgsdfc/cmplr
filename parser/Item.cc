...
int ParserBuilder::allocItem(const Item& item)
{
  ...
  itemSets.emplace
char *parser_builder_format_item(
    parser_builder *pb,
    int item_id)
{
...
int parser_builder_item_get_symbol (
    parser_builder *pb, 
    int item_id)
{
  item *it=pb->items + item_id;
...
int parser_builder_lookup_item(parser_builder *pb,
    item *it,
    int *item_id)
{
  item *pitem;
...
item_set *parser_builder_get_item_set(
    parser_builder *pb,
    int item_set_id)
{
...
int parser_builder_alloc_item_set(
    parser_builder *pb,
    item_set *set)
{
