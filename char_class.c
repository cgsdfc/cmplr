...
char *char_class2string[]=
{
  ...
  [ CHAR_CLASS_DEC_DIGITS_INT_SUFFIX_DOT ]=CC_DEC_DIGITS CC_INT_SUFFIX CC_DOT, /* [^dec, isf, .] */
  ...
  /* for single 0 */
  /* [^oct, isf, ., xX] */
  [ CHAR_CLASS_OCT_DIGITS_INT_SUFFIX_DOT_X ]=CC_OCT_DIGITS CC_INT_SUFFIX CC_DOT "xX",
