...
const char *tknzr_state_tab[]=
{
  ...
  [TK_INT_SUFFIX]="TK_INT_SUFFIX",
  [TK_FLOAT_SUFFIX]="TK_FLOAT_SUFFIX",
  [TK_INT_OCT_BEGIN]="TK_INT_OCT_BEGIN",
  [TK_INT_END]="TK_INT_END",
  [TK_FLOAT_END]="TK_FLOAT_END",
  [TK_INT_DEC_BEGIN]="TK_INT_DEC_BEGIN",
  ...
  [TK_FLOAT_EXPONENT_BEGIN]="TK_FLOAT_EXPONENT_BEGIN",
  [TK_INT_HEX_PREFIX]= "TK_INT_HEX_PREFIX",
